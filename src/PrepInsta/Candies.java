 ...
 * that is JAR can contain maximum N candies when JAR is full.
...
public class Candies {
    public static void main(String[] args) {
        ...
        System.out.println("Enter the total capacity of the jar: ");
        int n =scanner.nextInt();

        System.out.println("Enter the minimum threshold: ");
        int k=scanner.nextInt();

        int m=n; //Initial capacity

        while(true){
            System.out.println("Candies available in the jar: "+m);

            System.out.println("Enter the candies to purchase (0 to exit)");
            ...
            System.out.println("Candies are sold: "+x);
            System.out.println("Remaining candies: "+m);

            if(m<=k){
                System.out.println("refilling jar...");
                m=n;
                System.out.println("Jar refiled .. Candies are available: "+m);
            }
