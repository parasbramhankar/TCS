...
The task is to find index of the preinstall row(R) in the parking lot that has the most of
the parking spaces full(1).
...
public class Parking {
    public static void main(String[] args) {
        ...
        System.out.println("The row with most of the parking is full : "+(result+1));
    }
}
